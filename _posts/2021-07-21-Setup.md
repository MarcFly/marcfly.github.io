...
In the settings for the repository, select where to start searching for the entry `index.html` page and it will be displayed under either `user.github.io/ProjectName`. The domain name can be customized but I don't feel it is necessary to do for most projects.
...
If you don't have a personal page, create one. It is not a thing that will increase much our visibility, but it will serve a more polished and curated view to your own work towards other people.